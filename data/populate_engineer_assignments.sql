...
/* TODO: add NU Songrwiting club project spring 2018 still */
...
values (find_project_id('Mike Morrissey single'), find_engineer_id('Zac', 'Kerwin')),
       ...
       (find_project_id('3 songs by Du Vide'), find_engineer_id('Alex', 'Tran')),
       (find_project_id('3 songs by Du Vide'), find_engineer_id('Ethan', 'Finn')),
       (find_project_id('3 songs by Du Vide'), find_engineer_id('Sam', 'Alatalo')),
       (find_project_id('3 songs by Du Vide'), find_engineer_id('Kaitlyn', 'Dwyer')),
       ...
       (find_project_id('Mint Green single'), find_engineer_id('Seth', 'Rosenau')),
       (find_project_id('Mint Green single'), find_engineer_id('Joseph', 'Newmann')),
       (find_project_id('Mint Green single'), find_engineer_id('Nick', 'Leonard')),
       (find_project_id('Mint Green single'), find_engineer_id('Joshua', 'Garvey')),
       ...
       (find_project_id('Maggie Whitlock EP'), find_engineer_id('Paul', 'Kouris')),
       (find_project_id('Maggie Whitlock EP'), find_engineer_id('Nick', 'Smith')),
       (find_project_id('Maggie Whitlock EP'), find_engineer_id('Rachel', 'Lipson')),
       (find_project_id('Maggie Whitlock EP'), find_engineer_id('Hayley', 'Kuhlmann')),
       (find_project_id('Maggie Whitlock EP'), find_engineer_id('Craig', 'Short')),
       (find_project_id('Red Mill single'), find_engineer_id('Dan', 'Mulligan')),
       (find_project_id('Red Mill single'), find_engineer_id('Denzil', 'Leach')),
       (find_project_id('Red Mill single'), find_engineer_id('Nick', 'Smith')),
       (find_project_id('Red Mill single'), find_engineer_id('Joshua', 'Garvey')),
       (find_project_id('Red Mill single'), find_engineer_id('Hussain', 'Hamoudi')),
       ...
       (find_project_id('Gentle Temper single'), find_engineer_id('Joseph', 'Newmann')),
       (find_project_id('Gentle Temper single'), find_engineer_id('Zac', 'Kerwin')),
       (find_project_id('Gentle Temper single'), find_engineer_id('John', 'Calli')),
       (find_project_id('Gentle Temper single'), find_engineer_id('Chuck', 'Stein')),
       (find_project_id('Sweeps single'), find_engineer_id('Paul', 'Kouris')),
       (find_project_id('Sweeps single'), find_engineer_id('Tristan', 'Smith')),
       (find_project_id('Sweeps single'), find_engineer_id('Akhil', 'Bollu')),
       (find_project_id('Sweeps single'), find_engineer_id('Chuck', 'Stein')),
       (find_project_id('Sweeps single'), find_engineer_id('William', 'Kast')),
       (find_project_id('The Water Cycle single'), find_engineer_id('Melissa', 'Rorech')),
       (find_project_id('The Water Cycle single'), find_engineer_id('Rob', 'Steiner')),
       (find_project_id('The Water Cycle single'), find_engineer_id('Emily', 'Burke')),
       (find_project_id('The Water Cycle single'), find_engineer_id('Joseph', 'Callaghan')),
       (find_project_id('The Water Cycle single'), find_engineer_id('Emmett', 'Dwyer')),
       ...
       (find_project_id('Kid Wolf single'), find_engineer_id('Paul', 'Kouris')),
       (find_project_id('Kid Wolf single'), find_engineer_id('Aleksandra', 'Pasek')),
       (find_project_id('Kid Wolf single'), find_engineer_id('Lauren', 'Oldefendt')),
       (find_project_id('Kid Wolf single'), find_engineer_id('Zac', 'Kerwin')),
       (find_project_id('Kid Wolf single'), find_engineer_id('Emmett', 'Dwyer')),
